...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('trade', '0015_tradesettings_futures_leverage_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tps', to='trade.spotorder')),
            ],
            options={
                'db_table': 'spot_take_profits',
                'indexes': [models.Index(fields=['order', 'status'], name='spot_take_p_order_i_79536f_idx')],
            },
        ),
    ]
